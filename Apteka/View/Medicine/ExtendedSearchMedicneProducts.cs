...
namespace Apteka.View
{
	public partial class ExtendedSearchMedicneProducts : Form
	{
		...
		internal void SetParameters(string[] strParams, DateOnly[] doParams)
		{
			...
			dtpDateReleaseMin.Value = new DateTime(doParams[0], new TimeOnly());
			dtpDateReleaseMax.Value = new DateTime(doParams[1], new TimeOnly());
			dtpDateExpirationMin.Value = new DateTime(doParams[2], new TimeOnly());
			dtpDateExpirationMax.Value = new DateTime(doParams[3], new TimeOnly());
		}
