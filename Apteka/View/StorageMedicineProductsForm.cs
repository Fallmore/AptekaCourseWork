...
namespace Apteka
{
	public partial class StorageMedicineProductsForm : FormWithNotification
	{
		...
		{
			_viewModel.General.DatabaseNotificationService.Subscribe("storage_medicine_product",
				data =>
				{
		...
		{
			dgvStorageMedicineProducts.Columns["IdMedicineProduct"].Visible =
			dgvStorageMedicineProducts.Columns["IsCriticalAmount"].Visible =
			dgvStorageMedicineProducts.Columns["IdDepartment"].Visible =
			dgvStorageMedicineProducts.Columns["IdStorage"].Visible =
			dgvStorageMedicineProducts.Columns["IdPlace"].Visible = false;
		}
		...
		private async void SearchStorageMedicineProduct()
		{
			...
			bool isAnythingFind = await _viewModel.SearchStorageMedicineProductAsync(
