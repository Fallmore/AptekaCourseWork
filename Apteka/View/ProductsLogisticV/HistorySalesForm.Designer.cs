namespace Apteka.View
{
	partial class HistorySalesForm
	{
		...
		private void InitializeComponent()
		{
			...
			dgvHistorySaleMedicineProduct = new DataGridView();
			cmsHistorySales = new ContextMenuStrip(components);
			cmsHistorySalesMedicineProduct = new ContextMenuStrip(components);
			...
			((System.ComponentModel.ISupportInitialize)dgvHistorySaleMedicineProduct).BeginInit();
			SuspendLayout();
			// 
			// splitContainer1
			// 
			...
			dtpDateSaleMin.Format = DateTimePickerFormat.Time;
			...
			dtpDateSaleMax.Format = DateTimePickerFormat.Time;
			...
			// 
			splitContainer2.Panel1.Controls.Add(dgvHistorySales);
			// 
			// splitContainer2.Panel2
			// 
			splitContainer2.Panel2.Controls.Add(dgvHistorySaleMedicineProduct);
			splitContainer2.Size = new Size(836, 523);
			...
			dgvHistorySales.Size = new Size(836, 291);
			dgvHistorySales.TabIndex = 8;
			dgvHistorySales.CellMouseDown += dgv_CellMouseDown;
			dgvHistorySales.SelectionChanged += dgv_SelectionChanged;
			// 
			// dgvHistorySaleMedicineProduct
			// 
			dgvHistorySaleMedicineProduct.AllowUserToAddRows = false;
			dgvHistorySaleMedicineProduct.AllowUserToDeleteRows = false;
			dgvHistorySaleMedicineProduct.AllowUserToOrderColumns = true;
			dgvHistorySaleMedicineProduct.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableWithoutHeaderText;
			dgvHistorySaleMedicineProduct.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
			dgvHistorySaleMedicineProduct.Dock = DockStyle.Fill;
			dgvHistorySaleMedicineProduct.Location = new Point(0, 0);
			dgvHistorySaleMedicineProduct.MultiSelect = false;
			dgvHistorySaleMedicineProduct.Name = "dgvHistorySaleMedicineProduct";
			dgvHistorySaleMedicineProduct.ReadOnly = true;
			dgvHistorySaleMedicineProduct.SelectionMode = DataGridViewSelectionMode.FullRowSelect;
			dgvHistorySaleMedicineProduct.Size = new Size(836, 228);
			dgvHistorySaleMedicineProduct.TabIndex = 9;
			// 
			// cmsHistorySales
			// 
			cmsHistorySales.Name = "contextMenuStrip1";
			cmsHistorySales.Size = new Size(61, 4);
			// 
			// cmsHistorySalesMedicineProduct
			// 
			cmsHistorySalesMedicineProduct.Name = "contextMenuStrip1";
			cmsHistorySalesMedicineProduct.Size = new Size(61, 4);
			// 
			// HistorySalesForm
			// 
			...
			((System.ComponentModel.ISupportInitialize)dgvHistorySaleMedicineProduct).EndInit();
			ResumeLayout(false);
		}
		...
		private ContextMenuStrip cmsHistorySales;
		...
		private DataGridView dgvHistorySaleMedicineProduct;
		private ContextMenuStrip cmsHistorySalesMedicineProduct;
	}
}